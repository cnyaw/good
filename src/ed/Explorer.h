...
public:
  ...
  BEGIN_MSG_MAP_EX(CExplorerPropView)
    REFLECTED_NOTIFY_CODE_HANDLER_EX(PIN_BROWSE, OnBrowse)
    REFLECTED_NOTIFY_CODE_HANDLER_EX(PIN_ITEMCHANGING, OnPropChanging)
    REFLECTED_NOTIFY_CODE_HANDLER_EX(PIN_ITEMCHANGED, OnPropChanged)
    CHAIN_MSG_MAP(BaseT)
  END_MSG_MAP()
